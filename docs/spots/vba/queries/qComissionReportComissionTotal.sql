-- Query: qComissionReportComissionTotal
SELECT Users.FirstName, Users.LastName, 3 AS LineSort, "Comission Amount" AS LineItem, OrderItems.ItemType, Sum([OrderTotal]*[ComissionRate]) AS ComissionAmt
